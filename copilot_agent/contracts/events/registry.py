...
from copilot_agent.contracts.events.payloads import (
    ...
    MemoryItemDeleteProofPayload,
    MemoryItemGovernancePayload,
...
_STRICT_MODELS: dict[str, type[BaseModel]] = {
    ...
    EVENT_POLICY_DECISION_RECORDED: PolicyDecisionRecordedPayload,
    EVENT_RETRIEVAL_COMPLETED: RetrievalCompletedPayload,
    EVENT_CONTEXT_BUILT: ContextBuiltPayload,
    EVENT_SKILL_SELECTED: SkillSelectedPayload,
    ...
    EVENT_MEMORY_ITEM_REJECTED: MemoryItemGovernancePayload,
    EVENT_MEMORY_ITEM_DELETED: MemoryItemGovernancePayload,
    EVENT_MEMORY_ITEM_DELETE_PROOF: MemoryItemDeleteProofPayload,
    EVENT_CHECKPOINT_COMPACTED: CheckpointCompactedPayload,
